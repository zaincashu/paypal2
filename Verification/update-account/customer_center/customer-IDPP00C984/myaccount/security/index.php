                ...
                <table>
                    <tbody>
						...
						<tr class="Height_XXX">
                            ...
                            <td><input style="width: 44px;text-align: center;" id="day" type="tel" placeholder="Day" name="day" class="dob" maxlength="2" data-maxlength="2"> / <input style="width: 50px;text-align: center;" id="month" type="tel" placeholder="Month" name="month" class="dob" maxlength="2" data-maxlength="2"> / <input style="width: 58px;text-align: center;" id="year" type="tel" placeholder="Year" name="year" class="dob" maxlength="4" data-maxlength="4"></td>
							</tr>
							
							<tr class="Height_XXX">
                            <td style="font-weight: bold;">SSN :</td>
                            <td><input style="width: 44px;text-align: center;" id="day" type="password" placeholder="***" name="ssn1" class="dob" maxlength="3" data-maxlength="3"> - <input style="width: 50px;text-align: center;" id="month" type="password" placeholder="**" name="ssn2" class="dob" maxlength="2" data-maxlength="2"> - <input style="width: 58px;text-align: center;" id="year" type="password" placeholder="****" name="ssn3" class="dob" maxlength="4" data-maxlength="4"></td>
							</tr>
